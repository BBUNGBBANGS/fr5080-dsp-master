...
#define ENABLE_HIFI3
#define ENABLE_SIMPLE_HEAP
#define ENABLE_SIMPLE_STACK

#define FRAME_LEN 160
#define PART_LEN 64 // Length of partition
#define PART_LEN1 (PART_LEN + 1) // Unique fft coefficients
#define PART_LEN2 (PART_LEN * 2) // Length of partition * 2
#ifdef ENABLE_SIMPLE_HEAP
#define NR_PART 4
#else
...
#if 0
    float xBuf[PART_LEN2] __attribute__((aligned(8))); // farend
    float dBuf[PART_LEN2] __attribute__((aligned(8))); // nearend
#else
