...
MEMORY
{
  iram0_0_seg :                       	org = 0x000a0000, len = 0x400
  iram0_1_seg :                       	org = 0x000a0400, len = 0x17C
  iram0_2_seg :                       	org = 0x000a057C, len = 0x24
  iram0_3_seg :                       	org = 0x000a05A0, len = 0x40
  iram0_4_seg :                       	org = 0x000a05E0, len = 0x3C
  iram0_5_seg :                       	org = 0x000a061C, len = 0x20
  iram0_6_seg :                       	org = 0x000a063C, len = 0x20
  iram0_7_seg :                       	org = 0x000a065C, len = 0x24A4
  dram0_0_seg :                       	org = 0x00182000, len = 0x1000
}
PHDRS
{
...
PROVIDE(_memmap_vecbase_reset = 0xa0400);
PROVIDE(_memmap_reset_vector = 0xa0000);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x1e0000);
  _heap_sentry = 0x1e0000;
