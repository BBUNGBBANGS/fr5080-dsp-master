...
void audio_algorithm_init(void)
{
    ...
    audio_algorithm_env_tmp = (struct audio_algorithm_t *)pvPortMalloc_user(sizeof(struct audio_algorithm_t));
...
void audio_algorithm_release(void *msg)
{
    ...
    vPortFree_user((void *)audio_algorithm_env_tmp);
}

int16_t *audio_algorithm_get_plc_insert_buffer(uint8_t esco_data_mute)
{
    int16_t *buffer;
    uint8_t offset;
...
int16_t *audio_algorithm_get_local_in_write_buffer(void)
{
    int16_t *buffer;
...
static void audio_algorithm_ipc_rx(void)
{
...
static void audio_algorithm_ipc_tx(void)
{
    struct task_msg_t *msg;
